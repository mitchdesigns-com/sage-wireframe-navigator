      ...
      <section className="section-padding bg-gradient-to-br from-sage-50 to-white">
        <div className="container mx-auto text-center">
          <h1 className="heading-xl mb-6">
            Comprehensive Healthcare <span className="text-sage-400">Services</span>
          </h1>
          <p className="text-body max-w-3xl mx-auto">
            Discover our full range of healthcare solutions designed to meet the unique 
            needs of individuals, businesses, and organizations seeking exceptional medical 
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {serviceCategories.map((category) => {
              ...
              return (
                <div key={category.title} className="card group hover:shadow-2xl transition-all duration-300">
                  {/* Icon */}
