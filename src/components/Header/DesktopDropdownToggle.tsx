...
export default function DesktopDropdownToggle({
  ...
  return (
    ...
    >
      <div className="relative group-hover:opacity-80 ltr:font-aeonik-regular !rtl:font-arabic text-[16px] text-primary-spring not-italic text-nowrap leading-[0] transition-all duration-200 shrink-0">
