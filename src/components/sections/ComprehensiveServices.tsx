        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-20">
          {serviceCategories.map((category, _index) => (
            <div key={category.title} className="flex flex-col">
              ...
              <div className="bg-gray-200 rounded-4xl h-64 mb-6 flex items-center justify-center">
              ...
              <div className="">
                {category.links.map((link, linkIndex) => (
                  <Link
                    key={linkIndex}
                    href={link.href}
                    className="flex items-center justify-between text-gray-700 hover:text-sage-400 font-medium py-4 border-b border-gray-200 last:border-b-0 transition-colors duration-200 group"
                  >
