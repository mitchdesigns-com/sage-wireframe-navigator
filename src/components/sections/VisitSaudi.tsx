    ...
    <section className="section-padding bg-white">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Left Content */}
          <div>
            <div className="text-sm font-medium text-sage-400 mb-4">Visit Saudi</div>
            <h2 className="heading-lg mb-6">
              Discover the Excellence of Saudi Healthcare
            </h2>
            <p className="text-body mb-8">
              Saudi Arabia boasts state-of-the-art medical facilities, ensuring top-tier 
              care for all patients. Experience seamless travel accessibility and rich 
              cultural experiences that enhance your healthcare journey.
            </p>
          ...
          <div className="">
            <div className="bg-gray-200 rounded-2xl h-96 flex items-center justify-center">
              <div className="text-center text-gray-400">
                ...
                <p className="text-xs mt-1">Medical facilities & cultural highlights</p>
              </div>
            </div>
          </div>
        </div>
