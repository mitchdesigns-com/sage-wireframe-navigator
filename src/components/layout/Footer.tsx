...
// import { FooterData, FooterResponse } from '../../types/footer'
...
//   // Destructure all the data you need from the API response
//   const { menu, socialMedia, logo } = footerData
